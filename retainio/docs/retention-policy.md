...
correction to a recorded renewal outcome, and every retention offer emailed to a customer from the
platform, with the address it went to. Rejected discount requests must
